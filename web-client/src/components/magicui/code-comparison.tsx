...
export function CodeComparison({
  ...
  return (
    <div className="mx-auto w-full max-w-5xl">
      <div className="group relative w-full overflow-hidden rounded-md border border-[#66d1b5]">
        <div className="relative grid md:grid-cols-2">
          <div
            className={cn(
              "leftside group/left border-r border-[#66d1b5] md:border-r",
              hasLeftFocus &&
          ...
          >
            <div className="flex items-center border-b border-[#66d1b5] bg-slate-900 p-2 text-sm text-[#8bdfff]">
          ...
          <div
            className={cn(
              "rightside group/right border-t border-[#66d1b5] md:border-t-0",
              hasRightFocus &&
                "[&>div>pre>code>:not(.focused)]:!opacity-50 [&>div>pre>code>:not(.focused)]:!blur-[0.095rem]",
              "[&>div>pre>code>:not(.focused)]:transition-all [&>div>pre>code>:not(.focused)]:duration-300",
            )}
        ...
        <div className="absolute left-1/2 top-1/2 hidden h-8 w-8 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-md border border-[#66d1b5] bg-slate-900 text-xs text-[#8bdfff] md:flex">
          VS
        </div>
      </div>
    </div>
